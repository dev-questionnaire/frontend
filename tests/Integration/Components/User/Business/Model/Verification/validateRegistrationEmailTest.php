...
class validateRegistrationEmailTest extends KernelTestCase
{
    private ValidateRegistrationEmail $validateRegistrationEmail;
    ...
    protected function setUp(): void
    {
        ...
        $this->validateRegistrationEmail = $container->get(ValidateRegistrationEmail::class);
